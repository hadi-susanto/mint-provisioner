...
log_info \
    "[$CANONICAL_ID] Finding GitHub latest release using regex: $VSCODIUM_REGEX"
...
if ! url="$(
    ...
    log_error "[$CANONICAL_ID] No release asset matched regex: $VSCODIUM_REGEX"
    log_error "[$CANONICAL_ID] Please check https://github.com/VSCodium/vscodium/releases"
    log_error "[$CANONICAL_ID] Alternatively, set VSCODIUM_REGEX to manually select an asset"

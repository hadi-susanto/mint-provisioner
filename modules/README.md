...
Mint Provisioner currently provides **32 modules** across **7 categories**.
...
| [Development](DEV.md)           | `dev`  | `apache-maven`, `sdkman`                                                                          |
| [Desktop Applications](GUI.md)  | `gui`  | `cryptomator`, `double-commander`, `flameshot`, `keepass-xc`, `mu-commander`, `sunflower`         |
...
| [Miscellaneous](MISC.md)        | `misc` | Currently empty                                                                                   |

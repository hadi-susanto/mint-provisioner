...
Mint Provisioner currently provides **41 modules** across **7 categories**.
...
| [Development](DEV.md)           | `dev`  | `apache-maven`, `dbeaver-community`, `dbgate-community`, `mongodb-compass`, `sdkman`                            |

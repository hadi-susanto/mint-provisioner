...
Mint Provisioner currently provides **44 modules** across **7 categories**.
...
| [Development](DEV.md)           | `dev`  | `apache-maven`, `dbeaver-community`, `dbgate-community`, `docker`, `mongodb-compass`, `sdkman`                            |
| [Desktop Applications](GUI.md)  | `gui`  | `cryptomator`, `deadbeef`, `double-commander`, `flameshot`, `insync`, `keepass-xc`, `mu-commander`, `sunflower`, `tlp-ui` |
